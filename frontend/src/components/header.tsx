...
export const Header: React.FC = () => {
  const activeStyle = "text-[#F2BB44]";
  const defaultStyle = "text-white hover:text-[#F2BB44] ";
  const menuItems = [
    {
      label: "Beranda",
      href: "/",
      icon: (
        ...
        >
          <path
            d="M0 19.0459V6.34864L8.33333 0L16.6667 6.34864V19.0459H10.4167V11.6392H6.25V19.0459H0Z"
            fill="currentColor"
          />
        </svg>
      ),
  ...
  return (
    <header className=" bg-[#0f172a] shadow-sm px-6 py-2">
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
        <div className="logo flex items-center gap-2">
          <img src={logoSyubbanul} alt="logo" className="h-12" />
          <h1 className="text-white text-lg font-bold">Syubbanul Khoir</h1>
        </div>
