      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          ...
          <div>
            ...
            <p className="leading-relaxed text-[15px]">{info.alamat}</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {/* Instagram */}
              <a
                href={`https://www.instagram.com/${info.instagram}`} // Gabungkan URL Instagram + username
                target="_blank"
                rel="noreferrer"
              ...
              {/* TikTok */}
              <a
                href={`https://www.tiktok.com/@${info.tiktok}`} // TikTok butuh tanda @ di URL-nya sebelum username
                target="_blank"
                rel="noreferrer"
                aria-label="TikTok"
          ...
          <div>
            ...
            <p className="leading-relaxed text-slate-400">
              ©TeamPatavin Project ©PPMUHN {new Date().getFullYear()} All Rights
              Reserved.
            </p>
          </div>
        </div>
