...
// --- Komponen Ikon Sosial Media Sederhana (Sekarang menggunakan tag <a> agar berfungsi sebagai link) ---
const SocialIcon = ({
  bgColor,
  path,
  href,
  ...
  <a
    ...
    className={`w-8 h-8 ${bgColor} text-white rounded-full flex items-center justify-center hover:opacity-80 transition-opacity`}
  >
...
export default function DetailArtikel() {
  ...
  // Path SVG Ikon Sosial Media (Sudah ditambahkan path Facebook yang presisi)
  const icons = {
    whatsapp:
  ...
  // --- Ambil URL Halaman & Judul untuk dishare secara dinamis ---
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="w-full mb-10 overflow-hidden rounded-2xl shadow-sm">
          <img
            src={artikel.foto}
            alt={artikel.judul}
            className="w-full h-auto max-h-125 object-cover mx-auto"
          />
        </div>
