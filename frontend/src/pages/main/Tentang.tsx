  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-20 md:pt-0">
          <div>
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-white leading-tight">
              Tentang <br /> Syubbanul Khoir
            </h1>
          </div>
          <div>
            <p className="text-gray-200 text-sm md:text-base lg:text-lg leading-relaxed text-justify">
      ...
      <section className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          {/* --- BARIS 1 --- */}
          <div className="bg-white flex items-center justify-center p-12 md:p-16 border-b md:border-b-0 border-gray-100">
            <img 
              src={LogoSyubbanul} 
          ...
          <div className="bg-[#0f172a] text-white p-10 md:p-16 md:col-span-2 flex flex-col justify-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Sejarah Syubbanul Khoir</h2>
          ...
          {/* --- BARIS 2 --- */}
          {/* Visi (1 Kolom) */}
          <div className="bg-[#F2BB44] p-6 md:p-16 text-gray-900 flex flex-col justify-center">
            <h3 className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-2">
                <svg width="35" height="35" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="25.0003" cy="25" rx="14.5833" ry="14.5833" stroke="#0F172A" stroke-width="2"/>
                <ellipse cx="24.9997" cy="25" rx="4.16667" ry="4.16667" fill="#0F172A" stroke="#0F172A" stroke-width="5"/>
                <path d="M14.6876 14.688L8.33301 8.33392M35.3115 14.688L41.6663 8.33392M41.6663 41.6672L35.3115 35.3119M8.33301 41.6672L14.6876 35.3119" stroke="#0F172A" stroke-width="5" stroke-linecap="round"/>
                </svg>
              Visi
            </h3>
            <p className="text-sm md:text-base leading-relaxed text-justify font-medium">
          ...
          <div className="hidden md:block bg-[#0f172a]">
             {/* Sesuai desain, kotak ini dibiarkan putih kosong agar layout Sejarah menonjol */}
          </div>
