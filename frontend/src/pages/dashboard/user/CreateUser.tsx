...
// PERBAIKAN: Interface disesuaikan dengan skema kolom baru
interface UserForm {
  name: string;
...
export default function CreateUser() {
  ...
  // PERBAIKAN: Memantau perubahan field 'foto'
  ...
  const onSubmit = async (data: UserForm) => {
    try {
      ...
      if (!res.ok) throw new Error(result.message || "Gagal membuat user");
    ...
    <div className="p-2">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
          <div className="space-y-5">
            ...
            {/* PERBAIKAN: USERNAME (Menggantikan Email) */}
            <div className="flex flex-col gap-2">
            ...
            {/* PERBAIKAN: URL FOTO (Menggantikan Image URL) */}
            <div className="flex flex-col gap-2">
